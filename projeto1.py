...
def escolha_jogador():
    print('''
VOCÊ ESTÁ PRONTO PARA SALVAR A HUMANIDADE?
...
def enredo(jogador):
    print(f'''
VOCÊ ACORDA EM UMA SALA MAL ILUMINADA E POUCOS SEGUNDOS DEPOIS, UMA PESSOA ESTRANHA SE APROXIMA.
...
PLANETA LOCALIZADO A 1 ANO-LUZ DAQUI, E DEIXARAM NÓS AQUI PARA PERECER.
...
EXPLICANDO: "ANTES DE PARTIREM, OS RICOS DEIXARAM UM ESTOQUE DE VACINAS NA TERRA CAPAZ DE SALVAR A TODOS, MAS PARA TERMOS ACESSO A ELAS, É
...
"PARA COMEÇAR A JOGAR, VOCÊ PRECISA IR ATÉ O PORTO TAPAJÓS E ENTREGAR O PASSE DO JOGO, A PARTIR DAÍ, O JOGO COMEÇA E NÃO HÁ MAIS COMO VOLTAR. BOA SORTE." - Disse a cientista que se retirou do cômodo.
    ''')

def regras_jogo():
    print('''
VOCÊ ACORDOU UM POUCO TONTO E LOGO PERCEBEU QUE JUNTO A VOCÊ, TINHA UM MAPA QUE INDICAVA EXATAMENTE ONDE VOCÊ DEVERIA IR. QUE OS JOGOS COMECEM! 
